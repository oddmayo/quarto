...
| **Web sites** | `5 (11 planned, more on the way)` | 2 brands in 3 countries already receiving data |
...
In **parts pricing**, competitor data is important because it helps a business understand market trends, identify opportunities, and make better strategic decisions to gain and sustain competitive advantage.
:::
...
**GitHub Repo:**: DA-DS_parts_pricing

**Databricks workspace structure:**

```
📁 competitors_ppo_scraper/
├── 📂 oem_codes/
├── 📂 scraper_calls/
├── 📂 markets/
├── 📂 mystery_shopper/
...
| `mystery_shopper` | Data obtained from research |
...
|-----------|-----------|------------|------------|------------|---------|
| 806750050 | Transmission Oil Pump Seal | $9.87 | $7.81 | subaruparts.com | ![](https://flagcdn.com/20x15/cl.png) Chile |
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Chile - Both brands
    L.marker([-33.45, -71.5], {icon: bmwIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/cl.png" alt="CL"> Chile</b><br>BMW: 4 websites');
    L.marker([-35.5, -71.5], {icon: subaruIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/cl.png" alt="CL"> Chile</b><br>Subaru: 1 website');
    L.marker([-32.0, -71.5], {icon: dercoIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/cl.png" alt="CL"> Chile</b><br>Derco: 1 mystery shopper (Suzuki and Renault)');
    
    // Peru - Both brands  
    L.marker([-12.05, -78.0], {icon: bmwIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/pe.png" alt="PE"> Peru</b><br>4 websites');
    L.marker([-14.0, -76.0], {icon: subaruIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/pe.png" alt="PE"> Peru</b><br>1 website');
    
    // Colombia - Subaru only
    L.marker([4.7, -74.07], {icon: subaruIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/co.png" alt="CO"> Colombia</b><br>1 website');
    
    // Greece - Toyota
    L.marker([39.0, 22.0], {icon: toyotaIcon}).addTo(map).bindPopup('<b><img src="https://flagcdn.com/20x15/gr.png" alt="GR"> Greece</b><br>Toyota: 3 websites (third party)');
});
</script>
```
...
:::
::: {}
![](https://img.shields.io/badge/Toyota-Greece-EB0A1E?style=flat-square&logo=toyota&logoColor=white)
:::
:::
...
**Job name:** Scrapper_PPO

**Cluster used:** Scrapper_PPO_LATAM
...
| Brand | Sites |
|-------|-------|
| ![BMW](https://img.shields.io/badge/BMW-0066b1?style=flat-square&logo=bmw&logoColor=white) | bmwdirectparts.com |
| | bmwpartshub.com |
| | getbmwparts.com |
| | parts.bramanmotorsbmw.com |
| ![Subaru](https://img.shields.io/badge/Subaru-013C74?style=flat-square&logo=subaru&logoColor=white) | subaruparts.com |
...
| Task | Duration |
|------|----------|
| 🚀 Setup & initialization | ~10 min |
| 🔄 BMW sites (4) | ~100 hours |
| 🔄 Subaru site (1) | ~106 hours |
| 📊 Data consolidation | ~5 min |
| **Total** | **~106 hours** |
...
::: {.callout-note appearance="minimal"}
📋 **Status:** Evaluate proxy providers for enterprise compliance.
:::
...
If the assistant is sleeping, please hit the reload button and wait a few seconds, or simply reload the page to wake it up.
